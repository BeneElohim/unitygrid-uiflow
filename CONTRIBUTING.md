# Contributing to UnityGrid

Thank you for your interest in contributing to UnityGrid! This guide will help you set up your development environment and understand our development workflow.
...
- Check existing [Issues](https://github.com/bytedance/unitygrid/issues)
- Read the [Documentation](backend/docs/)
- Ask questions in [Discussions](https://github.com/bytedance/unitygrid/discussions)

## License

By contributing to UnityGrid, you agree that your contributions will be licensed under the [MIT License](./LICENSE).
