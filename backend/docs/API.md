...
This document provides a complete reference for the UnityGrid backend APIs.

## Overview

UnityGrid backend exposes two sets of APIs:
  ...
  "files": [
    {
      ...
      "size": 1234567,
      "path": ".unitygrid/threads/abc123/user-data/uploads/document.pdf",
      "virtual_path": "/mnt/user-data/uploads/document.pdf",
      "artifact_url": "/api/threads/abc123/artifacts/mnt/user-data/uploads/document.pdf",
      "markdown_file": "document.md",
      "markdown_path": ".unitygrid/threads/abc123/user-data/uploads/document.md",
...
Currently, UnityGrid does not implement authentication. All APIs are accessible without credentials.

Note: This is about UnityGrid API authentication. MCP outbound connections can still use OAuth for configured HTTP/SSE MCP servers.
