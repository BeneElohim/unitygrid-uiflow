...
{
  "graphs": {
    "lead_agent": "unitygrid.agents:lead_agent"
  },
...
```python
from unitygrid.config.title_config import TitleConfig, set_title_config
...
# 测试 title 生成
import pytest
from unitygrid.agents.title_middleware import TitleMiddleware
...
- [`packages/harness/unitygrid/agents/thread_state.py`](../packages/harness/unitygrid/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/unitygrid/agents/title_middleware.py`](../packages/harness/unitygrid/agents/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/unitygrid/config/title_config.py`](../packages/harness/unitygrid/config/title_config.py) - 配置管理
- [`config.yaml`](../config.yaml) - 配置文件
- [`packages/harness/unitygrid/agents/lead_agent/agent.py`](../packages/harness/unitygrid/agents/lead_agent/agent.py) - Middleware 注册
