...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: unitygrid-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. unitygrid.sandbox.local:LocalSandboxProvider)",
    )
