"""Live integration tests for UnityGridClient with real API.
...
from unitygrid.client import UnityGridClient, StreamEvent
...
def client():
    """Create a real UnityGridClient (no mocks)."""
    return UnityGridClient(thinking_enabled=False)
