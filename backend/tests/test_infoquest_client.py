...
from unitygrid.community.infoquest import tools
from unitygrid.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("unitygrid.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("unitygrid.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("unitygrid.community.infoquest.tools.get_app_config")
