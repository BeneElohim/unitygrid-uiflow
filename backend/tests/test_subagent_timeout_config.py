...
from unitygrid.config.subagents_config import (
...
class TestRegistryGetSubagentConfig:
    ...
    def test_returns_none_for_unknown_agent(self):
        from unitygrid.subagents.registry import get_subagent_config
...
class TestRegistryListSubagents:
    ...
    def test_lists_both_builtin_agents(self):
        from unitygrid.subagents.registry import list_subagents
