...
### 2. `backend/packages/harness/unitygrid/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/unitygrid/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_unitygrid_20260201.md`

```diff
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "UnityGrid GitHub Repository", "url": "https://github.com/bytedance/unitygrid", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
