#!/usr/bin/env bash
#
# start.sh - Start all UnityGrid development services
#
...
echo ""
echo "=========================================="
echo "  Starting UnityGrid Development Server"
echo "=========================================="
echo ""
if $DEV_MODE; then
...
echo "=========================================="
if $DEV_MODE; then
    echo "  ✓ UnityGrid development server is running!"
else
    echo "  ✓ UnityGrid production server is running!"
fi
echo "=========================================="
echo ""
