#!/usr/bin/env bash
#
# start-daemon.sh - Start all UnityGrid development services in daemon mode
#
# This script starts UnityGrid services in the background without keeping
...
echo ""
echo "=========================================="
echo " Starting UnityGrid in Daemon Mode"
echo "=========================================="
echo ""
...
if ! { \
    ...
    echo "✗ No UnityGrid config file found."
...
echo ""
echo "=========================================="
echo " UnityGrid is running in daemon mode!"
echo "=========================================="
echo ""
